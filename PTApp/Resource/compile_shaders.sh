...
$GLSL_COMPILER --target-env vulkan1.2 -V -S rchit "${SOURCE_FOLDER}shadow_ray_chit.glsl" -o "${BINARIES_FOLDER}shadow_ray_chit.spv"

# miss shaders
$GLSL_COMPILER --target-env vulkan1.2 -V -S rmiss "${SOURCE_FOLDER}ray_miss.glsl" -o "${BINARIES_FOLDER}ray_miss.bin"
$GLSL_COMPILER --target-env vulkan1.2 -V -S rmiss "${SOURCE_FOLDER}shadow_ray_miss.glsl" -o "${BINARIES_FOLDER}shadow_ray_miss.spv"
